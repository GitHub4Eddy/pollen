...
function QuickApp:updateLabels() -- Update labels
  ...
  labelText = labelText .."Date/time: " ..data.timestamp .."\n"
...
function QuickApp:getValues() -- Get the values
  ...
  data.updatedAt = jsonTable.data[1].updatedAt
  ...
  data.updatedAt = data.updatedAt:gsub("%.000Z", "") -- Clean up date/time
  data.updatedAt = data.updatedAt:gsub("%T", " ") -- Clean up date/time
  local runyear, runmonth, runday, runhour, runminute, runseconds = data.updatedAt:match(pattern)
...
function QuickApp:simData() -- Simulate Ambee API
  ...
  apiResult = '{"message": "Success","lat": 52.10,"lng": 5.17,"data": [{"Count": {"grass_pollen": 23,"tree_pollen": 172,"weed_pollen": 1},"Risk": {"grass_pollen": "Low","tree_pollen": "Moderate","weed_pollen": "Low"},"Species": {"Grass": {"Grass / Poaceae": 23},"Others": 4,"Tree": {"Alder": 3,"Birch": 61,"Cypress": 6,"Elm": 1,"Hazel": 0,"Oak": 44,"Pine": 29,"Plane": 20,"Poplar / Cottonwood": 5},"Weed": {"Chenopod": 0,"Mugwort": 0,"Nettle": 0,"Ragweed": 0}},"updatedAt": "2021-05-08T11:14:38.000Z"}]}'
...
function QuickApp:getQuickAppVariables() -- Get all variables 
  ...
  address = "https://api.ambeedata.com/latest/pollen/by-lat-lng" .."?lat=" ..latitude .."&lng=" ..longitude -- Combine webaddress and location info
